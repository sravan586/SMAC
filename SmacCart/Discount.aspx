<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Discount.aspx.cs" Inherits="SmacCart.Discount" %>
...
&nbsp;&nbsp;&nbsp; <strong>Category Name:&nbsp;&nbsp;&nbsp;&nbsp; </strong>
        <telerik:RadTextBox ID="category" Runat="server">
        </telerik:RadTextBox>
        <br />
        <strong>
        <br />
...
&nbsp;&nbsp;&nbsp; <strong>Discount:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong>
        <telerik:RadTextBox ID="discountvalue" Runat="server">
        </telerik:RadTextBox>
        <br />
        <br />
&nbsp;&nbsp;&nbsp; <strong>Start Time:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong>&nbsp;<telerik:RadDateTimePicker ID="start" Runat="server" Culture="en-IN">
        </telerik:RadDateTimePicker>
        <br />
        <br />
&nbsp;&nbsp; <strong>&nbsp;End Time:&nbsp; </strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <telerik:RadDateTimePicker ID="end" Runat="server">
        </telerik:RadDateTimePicker>
        <br />
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <telerik:RadButton ID="submit" runat="server" OnClick="submit_Click" Text="Submit">
        </telerik:RadButton>
        <br />
        <br />
