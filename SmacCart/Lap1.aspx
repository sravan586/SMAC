<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lap1.aspx.cs" Inherits="SmacCart.Electronics.laptops.prod.Lap1" %>
...
&nbsp;</strong></span></span></div> <!-- end of header -->
        ...
        <br />
        &nbsp;<asp:Image ID="Image1" runat="server" Height="204px" ImageUrl="~/Electronics/laptops/L_prod/27-1422366555-2-dellinspiron153542notebook.jpg" Width="316px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Product Name
...
&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Image ID="Image4" runat="server" Height="63px" ImageUrl="~/Electronics/laptops/L_prod/27-1422366555-2-dellinspiron153542notebook.jpg" Width="102px" />
&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            Specifications:<br />
            <br />
            <telerik:RadTextBox ID="specifications" Runat="server" TextMode="MultiLine" style="top: -29px; left: 182px; height: 148px;" Width="245px" Rows="30" Resize="Both">
            </telerik:RadTextBox>
            <br />
            <br />
            <br />
