...
namespace SmacCart.Electronics.laptops.prod
{
    public partial class Lap1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * from Laptops where Name='Dell'";
            ...
            if (DR1.Read())
            {
...

                {
                    ...
                    string query1 = "SELECT * from Deals where Name='Dell'";
                    ...
                    dbconnectionUpdate.Update("Update Laptops set Hits='" + hits.Text + "' where Name='Dell'", connStr);
            ...
            string query3 = "SELECT * from Cart where Name='Dell' and TransactionId != ''";
            ...
            dbconnectionUpdate1.Update("Update Laptops set Purchases='" + pur + "' where Name='Dell'", connStr1);
