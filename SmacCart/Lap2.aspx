<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Lap2.aspx.cs" Inherits="SmacCart.Electronics.laptops.prod.Lap2" %>
...
&nbsp;</strong></span></span></div> <!-- end of header -->
            ...
            <br />
            <br />
            <asp:Image ID="Image1" runat="server" Height="204px" ImageUrl="~/Electronics/laptops/L_prod/overview_wireless_hero_enhanced.png" Width="316px" />
        &nbsp;&nbsp; Product Name
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="buyy" runat="server" Text="Buy it!!" OnClick="buyy_Click" />
            ...
            <p>
                &nbsp;</p>
            <div style="height: 993px">
                <asp:Image ID="Image2" runat="server" Height="74px" ImageUrl="~/img/arrow-left-01-128.png" Width="83px" />
&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image3" runat="server" Height="63px" ImageUrl="~/Electronics/laptops/L_prod/overview_wireless_hero_enhanced.png" Width="101px" />
&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image4" runat="server" Height="63px" ImageUrl="~/Electronics/laptops/L_prod/e34fre45eer-qualixam-laptop-case-13mbpt-400x400-imadx7k5sccfh2mk.jpeg" Width="102px" />
&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                Specifications:<br />
                <br />
                <telerik:RadTextBox ID="specifications" Runat="server" TextMode="MultiLine" style="top: -22px; left: 201px; height: 444px; width: 284px;" Rows="30" Width="245px">
                </telerik:RadTextBox>
                <br />
                <br />
                <br />
                ...
                Also Viewed:<br />
                <br />
                <telerik:RadTextBox ID="competors" Runat="server" TextMode="MultiLine"  style="top: -7px; left: 6px">
                </telerik:RadTextBox>
                <br />
                <br />
                <br />
