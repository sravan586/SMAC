...
namespace SmacCart.Electronics.laptops.prod
{
    public partial class Lap2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * from Laptops where Name='Apple'";
            ...
            if (DR1.Read())
            {
...

                {
                    ...
                    string query1 = "SELECT * from Deals where Name='Apple'";
                    ...
                    dbconnectionUpdate.Update("Update Laptops set Hits='" + hits.Text + "' where Name='Apple'", connStr);
            ...
            string query3 = "SELECT * from Cart where Name='Apple' and TransactionId != ''";
            ...
            dbconnectionUpdate1.Update("Update Laptops set Purchases='" + pur + "' where Name='Apple'", connStr1);
