<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Laptop.aspx.cs" Inherits="SmacCart.Electronics.laptops.Laptop" %>
...
&nbsp;</strong></span></span></div> <!-- end of header -->
        ...
        <div>
            <asp:HyperLink ID="HyperLink1" runat="server" ImageHeight="300px" ImageUrl="~/Electronics/laptops/L_prod/27-1422366555-2-dellinspiron153542notebook.jpg" ImageWidth="300px" NavigateUrl="~/Lap1.aspx">HyperLink</asp:HyperLink>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:HyperLink ID="HyperLink2" runat="server" ImageHeight="300px" ImageUrl="~/Electronics/laptops/L_prod/overview_wireless_hero_enhanced.png" ImageWidth="300px" NavigateUrl="~/Lap2.aspx">HyperLink</asp:HyperLink>
            <br />
        </div>
    </form>
      <p>
