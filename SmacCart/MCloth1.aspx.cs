...
namespace SmacCart.Men.Clothing.prod
{
    public partial class MCloth1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string conn = ConfigurationManager.ConnectionStrings["SMACLibrary"].ConnectionString;
            string query = "SELECT * from Clothing where Name='Twills'";
            ...
            if (DR1.Read())
            {
                ...
                competors.Text = DR1[7].ToString();
                {
                    ...
                    string query1 = "SELECT * from Deals where Name='Twills'";
                    ...
                    dbconnectionUpdate.Update("Update Clothing set Hits='" + hits.Text + "' where Name='Twills'", connStr);
            ...
            string query3 = "SELECT * from Cart where Name='Twills' and TransactionId != ''";
            ...
            dbconnectionUpdate1.Update("Update Clothing set Purchases='" + pur + "' where Name='Twills'", connStr1);
