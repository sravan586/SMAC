...
{
    public partial class M_Cloth2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string conn = ConfigurationManager.ConnectionStrings["SMACLibrary"].ConnectionString;
            string query = "SELECT * from Clothing where Name='Lewis'";
            ...
            if (DR1.Read())
            {
                ...
                competors.Text = DR1[7].ToString();
                {
                    ...
                    string query1 = "SELECT * from Deals where Name='Lewis'";
                    ...
                    dbconnectionUpdate.Update("Update Clothing set Hits='" + hits.Text + "' where Name='Lewis'", connStr);
            ...
            string query3 = "SELECT * from Cart where Name='Lewis' and TransactionId != ''";
            ...
            dbconnectionUpdate1.Update("Update Clothing set Purchases='" + pur + "' where Name='Lewis'", connStr1);
