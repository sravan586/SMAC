...
{
    public partial class M_Fooot2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string conn = ConfigurationManager.ConnectionStrings["SMACLibrary"].ConnectionString;
            string query = "SELECT * from Footware where Name='Bata'";
            ...
            if (DR1.Read())
            {
                ...
                competors.Text = DR1[7].ToString();
                {
                    ...
                    string query1 = "SELECT * from Deals where Name='Bata'";
                    ...
                    dbconnectionUpdate.Update("Update Footware set Hits='" + hits.Text + "' where Name='Bata'", connStr);
            ...
            string query3 = "SELECT * from Cart where Name='Bata' and TransactionId != ''";
            ...
            dbconnectionUpdate1.Update("Update Footware set Purchases='" + pur + "' where Name='Bata'", connStr1);
