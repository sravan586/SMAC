...
namespace SmacCart.Men.Footware.M_FootProd
{
    public partial class M_Foot1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string conn = ConfigurationManager.ConnectionStrings["SMACLibrary"].ConnectionString;
            string query = "SELECT * from Footware where Name='Woodland'";
            ...
            if (DR1.Read())
            {
                ...
                competors.Text = DR1[7].ToString();
                {
                    ...
                    string query1 = "SELECT * from Deals where Name='Woodland'";
                    ...
                    dbconnectionUpdate.Update("Update Footware set Hits='" + hits.Text + "' where Name='Woodland'", connStr);
            ...
            string query3 = "SELECT * from Cart where Name='Woodland' and TransactionId != ''";
            ...
            dbconnectionUpdate1.Update("Update Footware set Purchases='" + pur + "' where Name='Woodland'", connStr1);
