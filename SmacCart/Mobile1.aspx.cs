...
namespace SmacCart.Electronics.Mobiles.prod
{
    public partial class Mobile1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * from Mobiles where Name='Nokia'";
            ...
            if (DR1.Read())
            {
...

                {
                    ...
                    string query1 = "SELECT * from Deals where Name='Nokia'";
                    ...
                    dbconnectionUpdate.Update("Update Mobiles set Hits='" + hits.Text + "' where Name='Nokia'", connStr);
            ...
            string query3 = "SELECT * from Cart where Name='Nokia' and TransactionId != ''";
            ...
            dbconnectionUpdate1.Update("Update Mobiles set Purchases='" + pur + "' where Name='Nokia'", connStr1);
