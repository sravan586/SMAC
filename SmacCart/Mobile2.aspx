<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mobile2.aspx.cs" Inherits="SmacCart.Electronics.Mobiles.prod.Mobile2" %>
...
&nbsp;</strong></span></span></div> <!-- end of header -->
        ...
        <div>
            ...
            <asp:Image ID="Image1" runat="server" Height="204px" ImageUrl="~/Electronics/Mobiles/M_prod/samsung-galaxy-grand-2-400x400-imadrrywbu58meym.jpeg" Width="316px" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Product Name
...
&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image3" runat="server" Height="55px" ImageUrl="~/Electronics/Mobiles/M_prod/samsung-galaxy-grand-2-400x400-imadrrywbu58meym.jpeg" Width="66px" />
&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image4" runat="server" Height="60px" ImageUrl="~/Electronics/Mobiles/M_prod/samsung-galaxy-grand-2-400x400-imadrrywvfvv2apy.jpeg" Width="49px" />
&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Image ID="Image5" runat="server" Height="61px" ImageUrl="~/Electronics/Mobiles/M_prod/samsung-galaxy-grand-2-400x400-imadrrywyhfn4zhr.jpeg" Width="44px" />
&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <br />
                Specifications:<br />
                <telerik:RadTextBox ID="specifications" Runat="server" TextMode="MultiLine" Rows="30" style="top: -5px; left: 165px; height: 353px" Width="245px">
                </telerik:RadTextBox>
                <br />
                <br />
                <br />
