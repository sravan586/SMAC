...
namespace SmacCart.Electronics.Mobiles.prod
{
    public partial class Mobile2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * from Mobiles where Name='Samsung'";
            ...
            if (DR1.Read())
            {
                ...
                competors.Text = DR1[7].ToString();
                {
                    ...
                    string query1 = "SELECT * from Deals where Name='Samsung'";
                    ...
                    dbconnectionUpdate.Update("Update Mobiles set Hits='" + hits.Text + "' where Name='Samsung'", connStr);
                    Conn1.Close();
            ...
            string query3 = "SELECT * from Cart where Name='Samsung' and TransactionId != ''";
            ...
            dbconnectionUpdate1.Update("Update Mobiles set Purchases='" + pur + "' where Name='Samsung'", connStr1);
