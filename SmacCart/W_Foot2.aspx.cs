...
{
    public partial class W_Foot2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string conn = ConfigurationManager.ConnectionStrings["SMACLibrary"].ConnectionString;
            string query = "SELECT * from W_Footware where Name='Do Bhai'";
            ...
            if (DR1.Read())
            {
                ...
                competors.Text = DR1[7].ToString();
                {
                    ...
                    string query1 = "SELECT * from Deals where Name='Do Bhai'";
                    ...
                    else
                    {
                     ...
                     dbconnectionUpdate.Update("Update W_Footware set Hits='" + hits.Text + "' where Name='Do Bhai'", connStr);
            ...
            string query3 = "SELECT * from Cart where Name='Do Bhai' and TransactionId != ''";
            ...
            dbconnectionUpdate1.Update("Update W_Footware set Purchases='" + pur + "' where Name='Do Bhai'", connStr1);
