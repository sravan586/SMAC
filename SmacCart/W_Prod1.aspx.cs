...
{
    public partial class W_Prod1 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string conn = ConfigurationManager.ConnectionStrings["SMACLibrary"].ConnectionString;
            string query = "SELECT * from W_Clothing where Name='Shakumbhari'";
            ...
            if (DR1.Read())
            {
                ...
                competors.Text = DR1[7].ToString();
                {
                    ...
                    string query1 = "SELECT * from Deals where Name='Shakumbhari'";
                    ...
                    else
                    {
                     ...
                     dbconnectionUpdate.Update("Update W_Clothing set Hits='" + hits.Text + "' where Name='Shakumbhari'", connStr);
            ...
            string query3 = "SELECT * from Cart where Name='Shakumbhari' and TransactionId != ''";
            ...
            dbconnectionUpdate1.Update("Update W_Clothing set Purchases='" + pur + "' where Name='Shakumbhari'", connStr1);
