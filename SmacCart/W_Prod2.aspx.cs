...
{
    public partial class W_Prod2 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            string conn = ConfigurationManager.ConnectionStrings["SMACLibrary"].ConnectionString;
            string query = "SELECT * from W_Clothing where Name='Ishin'";
            ...
            if (DR1.Read())
            {
                ...
                competors.Text = DR1[7].ToString();
                {
                    ...
                    string query1 = "SELECT * from Deals where Name='Ishin'";
                    ...
                    dbconnectionUpdate.Update("Update W_Clothing set Hits='" + hits.Text + "' where Name='Ishin'", connStr);
            ...
            string query3 = "SELECT * from Cart where Name='Ishin' and TransactionId != ''";
            ...
            dbconnectionUpdate1.Update("Update W_Clothing set Purchases='" + pur + "' where Name='Ishin'", connStr1);
