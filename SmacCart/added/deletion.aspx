<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="deletion.aspx.cs" Inherits="Smac_Screen1.deletion" %>
...
&nbsp;&nbsp;<asp:TextBox ID="TextBox4" runat="server" Height="28px" Width="279px"></asp:TextBox>
        ...
        <div>
            ...
            <br />
            Category Name:&nbsp;
            <telerik:RadTextBox ID="categoryname" Runat="server" EnableSingleInputRendering="True" LabelWidth="64px">
            </telerik:RadTextBox>
            <br />
            <br />
            Name :&nbsp;&nbsp;
            ...
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <telerik:RadButton ID="delete" runat="server" OnClick="delete_Click" Text="delete">
            </telerik:RadButton>
        </div>
