<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact_Us.aspx.cs" Inherits="SmacCart.contact_Us" %>
...
&nbsp;</strong></span></span></div> <!-- end of header -->
        ...
        Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :<asp:TextBox ID="email" runat="server"></asp:TextBox>
            <br />
        <br />
        Subject&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :<telerik:RadTextBox ID="subject" Runat="server" EnableSingleInputRendering="True" LabelWidth="64px" TextMode="MultiLine">
        </telerik:RadTextBox>
        <br />
        <br />
        Message&nbsp;&nbsp;&nbsp; :<telerik:RadTextBox ID="message" Runat="server" TextMode="MultiLine" style="top: 9px; left: 14px">
        </telerik:RadTextBox>
            <br />
        <br />
        <br />
